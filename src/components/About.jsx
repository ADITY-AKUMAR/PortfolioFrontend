    ...
    >
      <div className="mx-auto max-w-4xl">
        ...
        >
          ...
          (2022 – 2026), passionate about full-stack development and UI/UX
          design. I build scalable web applications with clean interfaces and
          real-world impact—from e-commerce platforms with payments and admin
          panels to real-time chat apps and analytics dashboards. I'm focused on
          SDE/UI-UX roles where I can ship quality products and grow as an
          engineer.
        </motion.p>
