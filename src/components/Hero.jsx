...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 pt-20 pb-16"
    >
      <div className="mx-auto max-w-5xl w-full flex flex-col md:flex-row items-center gap-10 md:gap-14">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <motion.h2
            ...
            className="text-2xl sm:text-3xl font-semibold text-zinc-700 dark:text-zinc-300 mb-4"
          >
            Frontend Developer
          </motion.h2>
          <motion.p
          ...
          >
            Currently working at Pine Labs. Available for Full-Time
            Opportunities.
          </motion.p>
          ...
          >
            ...
            <button
              ...
              className="rounded-xl border border-zinc-300 dark:border-zinc-600 text-zinc-800 dark:text-zinc-200 font-medium px-6 py-3 bg-white/90 dark:bg-zinc-900/90 hover:border-emerald-500 dark:hover:border-emerald-500 transition-all hover:scale-105"
            >
              View Projects
            </button>
            <button
